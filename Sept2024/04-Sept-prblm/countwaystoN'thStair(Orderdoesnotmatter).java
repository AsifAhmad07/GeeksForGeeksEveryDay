package 04-Sept-prblm;

public class countwaystoN'thStair(Orderdoesnotmatter) {


    Name Of The Problem :- Count ways to N'th Stair(Order does not matter)

    POTD :- 04-September-2024
